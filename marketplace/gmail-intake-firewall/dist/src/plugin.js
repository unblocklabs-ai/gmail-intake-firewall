...
function buildDoctorFindings(config, validation, status, auth) {
    ...
    const authSources = Array.isArray(auth.sources) ? auth.sources : [];
    ...
    const statusSources = Array.isArray(status.sources) ? status.sources : [];
