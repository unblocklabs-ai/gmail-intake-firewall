import type { InboundMessage, NormalizedMessageForClassification, SecurityClassification, SecurityConfig } from "./types.js";
...
export declare function normalizeMessageForSecurity(message: InboundMessage, maxBodyChars: number): NormalizedMessageForClassification;
